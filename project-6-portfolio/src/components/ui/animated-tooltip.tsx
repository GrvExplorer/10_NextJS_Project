      ...
      {items.map((item, idx) => (
        ...
        >
          ...
          <Image
            ...
            src={item.image}
            alt={item.name}
            className="object-cover !m-0 p-2 bg-white dark:bg-black-100 rounded-full h-10 w-10 border-2 group-hover:scale-105 group-hover:z-50 dark:border-black-300  relative transition duration-500"
          />
        </div>
      ))}
    </>
